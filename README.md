...
- **⚔ ready badges** — each neighbor gets a map badge with the slider % you'd need to commit 1.66× their troops (the loss-clamp optimum); `MAX n×` when even 100% falls short. The color is a smooth gradient on what your **spendable** troops (pool minus the 40%-of-cap growth floor) could afford against them, independent of your slider: red → orange → **yellow** (you can match their army 1×) → **green** (you can afford the 1.66× optimum) → **blue** (2×+, overwhelming). Bots marked 🤖. Toggle with the `⚔ ready %` pill.
